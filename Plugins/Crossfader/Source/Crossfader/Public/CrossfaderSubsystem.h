...
public:
	...
	UPROPERTY(config, EditAnywhere, Category=Crossfader, meta = (AllowedClasses = "SoundControlBusMix"))
	...
	UPROPERTY(config, EditAnywhere, Category = Crossfader, meta = (AllowedClasses = "MixStateBank"))
