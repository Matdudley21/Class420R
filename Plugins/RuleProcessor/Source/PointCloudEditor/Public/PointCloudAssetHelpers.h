...
public:
	...
	*/
	...
	UFUNCTION(BlueprintCallable, Category = "PointCloud")
	static void DeleteAllActorsOnDataLayer(UWorld* InWorld, const FString& InDataLayerName);
	...
	*/
	...
	static void ParseModulesOnActor(AActor* InActor, const TArray<FString>& InDataLayerLabels, TArray<FPointCloudPoint>& OutModules);
	...
	static TArray<FPointCloudPoint> GetModulesFromDataLayers(UWorld* InWorld, const TArray<FString>& InDataLayerNames);
