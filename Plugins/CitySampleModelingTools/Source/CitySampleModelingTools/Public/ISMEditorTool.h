 ...
 */
UCLASS()
class CITYSAMPLEMODELINGTOOLS_API UISMEditorToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class CITYSAMPLEMODELINGTOOLS_API UISMEditorToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()
public:
...
UCLASS()
class CITYSAMPLEMODELINGTOOLS_API UISMEditorToolActionPropertySetBase : public UInteractiveToolPropertySet
{
	GENERATED_BODY()
public:
...
UCLASS()
class CITYSAMPLEMODELINGTOOLS_API UISMEditorToolActionPropertySet : public UISMEditorToolActionPropertySetBase
{
	GENERATED_BODY()
public:
...
UCLASS()
class CITYSAMPLEMODELINGTOOLS_API UISMEditorToolReplacePropertySet : public UISMEditorToolActionPropertySetBase
{
	GENERATED_BODY()
public:
	UPROPERTY(EditAnywhere, Category = Replace)
	UStaticMesh* ReplaceWith = nullptr;
 ...
 */
UCLASS()
class CITYSAMPLEMODELINGTOOLS_API UISMEditorTool : public UInteractiveTool, public IInteractiveToolCameraFocusAPI, public IClickBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	UPROPERTY()
	UISMEditorToolProperties* TransformProps;

	UPROPERTY()
	UISMEditorToolActionPropertySet* ToolActions;

	UPROPERTY()
	UISMEditorToolReplacePropertySet* ReplaceAction;

	UPROPERTY()
	TArray<UInstancedStaticMeshComponent*> TargetComponents;
...
class CITYSAMPLEMODELINGTOOLS_API FISMEditorSelectionChange : public FToolCommandChange
{
public:
...
class CITYSAMPLEMODELINGTOOLS_API FISMEditorSceneChange : public FToolCommandChange
{
public:
