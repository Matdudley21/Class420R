...
void UMassTrafficParkedVehicleUpdateCustomVisualizationProcessor::Initialize(UObject& Owner)
{
...
void UMassTrafficParkedVehicleUpdateCustomVisualizationProcessor::Execute(UMassEntitySubsystem& EntitySubsystem, FMassExecutionContext& Context)
{
