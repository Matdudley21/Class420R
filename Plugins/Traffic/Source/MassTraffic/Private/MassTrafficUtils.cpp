...
void FindNearestVehiclesInLane(const UMassEntitySubsystem& EntitySubsystem, const FZoneGraphTrafficLaneData& TrafficLaneData, float Distance, FMassEntityHandle& OutPreviousVehicle, FMassEntityHandle& OutNextVehicle)
{
	...
	else
	{
		...
		const FMassZoneGraphLaneLocationFragment& TailVehicleLaneLocationFragment = EntitySubsystem.GetFragmentDataChecked<FMassZoneGraphLaneLocationFragment>(TrafficLaneData.TailVehicle);
		...
		else
		{
			...
			OutNextVehicle = EntitySubsystem.GetFragmentDataChecked<FMassTrafficNextVehicleFragment>(OutPreviousVehicle).GetNextVehicle();
			int32 LoopCount = 0;
			while (OutPreviousVehicle.IsSet())
			{
				if (OutNextVehicle.IsSet())
				{
					const FMassZoneGraphLaneLocationFragment& NextVehicleLaneLocationFragment = EntitySubsystem.GetFragmentDataChecked<FMassZoneGraphLaneLocationFragment>(OutNextVehicle);
