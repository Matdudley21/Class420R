...
void UMassTrafficLightUpdateCustomVisualizationProcessor::Initialize(UObject& Owner)
{
...
void UMassTrafficLightUpdateCustomVisualizationProcessor::Execute(UMassEntitySubsystem& EntitySubsystem, FMassExecutionContext& Context)
{
