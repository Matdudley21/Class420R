...
void UMassTrafficInitTrailersProcessor::Execute(UMassEntitySubsystem& EntitySubsystem, FMassExecutionContext& Context)
{
	...
	EntityQuery.ForEachEntityChunk(EntitySubsystem, Context, [&](FMassExecutionContext& QueryContext)
	{
		...
		for (int32 EntityIndex = 0; EntityIndex < NumEntities; ++EntityIndex)
		{
			...
			{
				FMassEntityView VehicleMassEntityView(EntitySubsystem, VehicleConstraintFragment.Vehicle);
