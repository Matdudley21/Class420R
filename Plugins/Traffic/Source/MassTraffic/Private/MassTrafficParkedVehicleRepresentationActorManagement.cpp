...
EMassActorSpawnRequestAction  UMassTrafficParkedVehicleRepresentationActorManagement::OnPostActorSpawn(const FMassActorSpawnRequestHandle& SpawnRequestHandle, FConstStructView SpawnRequest, UMassEntitySubsystem* EntitySubsystem) const
{
	...
	FMassEntityView ParkedVehicleEntityView(*EntitySubsystem, MassActorSpawnRequest.MassAgent);
