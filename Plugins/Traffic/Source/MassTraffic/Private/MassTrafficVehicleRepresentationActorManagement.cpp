...
EMassActorSpawnRequestAction UMassTrafficVehicleRepresentationActorManagement::OnPostActorSpawn(const FMassActorSpawnRequestHandle& SpawnRequestHandle, FConstStructView SpawnRequest, UMassEntitySubsystem* EntitySubsystem) const
{
	...
	check(EntitySubsystem);
	FMassEntityView EntityView(*EntitySubsystem, MassActorSpawnRequest.MassAgent);
