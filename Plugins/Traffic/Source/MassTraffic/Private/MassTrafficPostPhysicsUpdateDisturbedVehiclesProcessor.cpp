...
void UMassTrafficPostPhysicsUpdateDisturbedVehiclesProcessor::Execute(UMassEntitySubsystem& EntitySubsystem, FMassExecutionContext& Context)
{
	// The main point of this processor is to update Mass with the location of the actor.
	DisturbedVehicleQuery.ForEachEntityChunk(EntitySubsystem, Context, [&](FMassExecutionContext& ComponentSystemExecutionContext)
	{
