...
struct MASSTRAFFIC_API FZoneGraphTrafficLaneData
{
	 ...
	 */
	void ForEachVehicleOnLane(const UMassEntitySubsystem& EntitySubsystem, FTrafficVehicleExecuteFunction Function) const;
	...
	float SpaceAvailableFromStartOfLaneForVehicle(const UMassEntitySubsystem& EntitySubsystem, const bool bCheckLaneChangeGhostVehicles, const bool bCheckSplittingAndMergingGhostTailVehicles) const;
