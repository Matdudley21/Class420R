...
public:	
	...
	UPROPERTY(EditAnywhere, Instanced, Category=Field, Meta = (BaseStruct = "MassTrafficFieldOperationBase"))
	...
	void UpdateOverlappedIntersections(UMassTrafficSubsystem* MassTrafficSubsystem);
