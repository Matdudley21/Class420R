...
void VisLogMalformedNextLaneLinks(const UMassEntitySubsystem& EntitySubsystem, int32 LaneIndex, const FMassEntityHandle TailVehicle, const FMassEntityHandle UndiscoveredVehicle, int32 MarchEjectAt, const UObject* VisLogOwner);
...
inline void VisLogMalformedNextLaneLinks(const UMassEntitySubsystem& EntitySubsystem, int32 LaneIndex, const FMassEntityHandle TailVehicle, const FMassEntityHandle UndiscoveredVehicle, int32 MarchEjectAt, const UObject* VisLogOwner) {}
