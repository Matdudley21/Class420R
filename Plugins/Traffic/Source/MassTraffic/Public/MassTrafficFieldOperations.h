...
{
	FMassTrafficFieldOperationContextBase(UMassTrafficSubsystem& InMassTrafficSubsystem, UMassEntitySubsystem& InEntitySubsystem, UZoneGraphSubsystem& InZoneGraphSubsystem)
...
protected:
	...
	/** Note that this implementation is left empty since UMassProcessor_TrafficFieldOperations and its subclasses don't really perform query-based operations. */
