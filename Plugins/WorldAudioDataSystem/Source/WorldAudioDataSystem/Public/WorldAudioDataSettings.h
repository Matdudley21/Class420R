...
// 	FString MantleColorPointMetaDataKey = TEXT("type");
	...
	UPROPERTY(config, EditAnywhere, Category = "WorldAudioDataContinuousSound", meta = (AllowedClasses = "SoundBase"))
	...
	UPROPERTY(config, EditAnywhere, Category = "WorldAudioDataGameplay", meta = (AllowedClasses = "WADVehAudioPreset"))
